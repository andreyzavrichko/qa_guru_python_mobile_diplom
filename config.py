...
def to_driver_options(context):
    ...
    if context == 'local_emulator':
        ...
        options.set_capability('appWaitActivity', os.getenv(
            'APP_WAIT_ACTIVITY'))
        options.set_capability('app', mobile_diplom.utils.file.abs_path_from_project(os.getenv('APP')))
    ...
    if context == 'bstack':
        ...
        load_dotenv(dotenv_path=mobile_diplom.utils.file.abs_path_from_project(
            '.env.credentials'))
